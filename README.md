...
|---|---|---|---|
| 📱 **Phone & Tablet** | **IDLIX** | [**Download IDLIX.apk**](https://github.com/Asadaaaaa/IDLIX-App/releases/download/v2.1.1/IDLIX.apk) | Fullscreen edge-to-edge viewing, touch controls, LAN TV remote, realtime Touchpad & scroll |
| 📺 **Android TV & STB Box** | **IDLIX TV** | [**Download IDLIX-TV.apk**](https://github.com/Asadaaaaa/IDLIX-App/releases/download/v2.1.1/IDLIX-TV.apk) | Works with your TV remote, Virtual Mouse Cursor, auto-play film, LAN Remote receiver, big-screen zoom |

- **Latest Release:** [IDLIX-App v2.1.1 on GitHub](https://github.com/Asadaaaaa/IDLIX-App/releases/tag/v2.1.1)
